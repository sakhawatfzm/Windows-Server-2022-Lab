First install the FSRM(File server resources manager)
...
in server we create two folder quotadata and screeningdata and both folder as share folder and persmission give all to that we can accees anywere to testing purpose
...
Now in Pc1 type win + r then type \\10.0.0.2 then I can see the folder of server 
...
When I try to transfer more than 4mb it's deny.which is our main goal
...
After increasing 4mb to 10mb I can paste file(5mb) 
